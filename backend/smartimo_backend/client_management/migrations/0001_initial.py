    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clients', to='property_listing.realestateagent')),
            ],
            bases=('core.user',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client_management.client')),
            ],
